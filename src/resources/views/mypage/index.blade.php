...
@section('content')
    <div class="p-5 mypage-index">
        <div class="pt-5 pb-3 mypage-container">
            ...
            <div class="my-5 d-flex flex-row mypage-wrapper">
                <div class="m-5 text-center profile_top">
                    <img src="" alt="profile_img" class="m-3 profile_img">
                    <p class="m-2 h3">{{ $user->nickname }}</p>
                </div>
                <div class="m-5 mypage-inner">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="wallet-tab" data-toggle="tab" href="#wallet" role="tab" aria-controls="wallet" aria-selected="true">獲得金額</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">登録情報</a>
                        </li>
                    </ul>
                        ...
                        <div class="p-5 text-center profile_detail">
                            <table class="mb-5 profile_table">
                                <tbody>
                                    <tr>
                                        <td class="py-3">名前</td>
                                        <td class="pl-4 py-3">{{ $user->first_name }} {{ $user->last_name }}</td>
                                    </tr>
                                    <tr>
                                        <td class="py-3">カナ</td>
                                        <td class="pl-4 py-3">{{ $user->first_name_ruby }} {{ $user->last_name_ruby }}</td>
                                    </tr>
                                    <tr>
